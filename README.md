...
String Plus — это учебный проект, в рамках которого реализована собственная версия библиотеки string.h на языке C с дополнениями. Все функции разработаны с нуля в соответствии со стандартом POSIX и покрыты модульными тестами с использованием библиотеки Check.

## Содержание

- [Введение](#введение)
- [Информация](#информация)
  - [Стандартная библиотека string.h](#стандартная-библиотека-stringh)
  - [Форматирование строк (sprintf и sscanf)](#форматирование-строк-sprintf-и-sscanf)
  - [Специальные функции обработки строк](#специальные-функции-обработки-строк-вдохновленные-классом-string-в-языке-c)
- [Требования к проекту](#требования-к-проекту)
  - [Реализация функций библиотеки string.h](#part-1-реализация-функций-библиотеки-stringh)  
  - [Частичная реализация функции sprintf](#part-2-частичная-реализация-функции-sprintf)  
  - [Дополнительно. Реализация некоторых модификаторов формата функции sprintf](#part-3-дополнительно-реализация-некоторых-модификаторов-формата-функции-sprintf)  
  - [Дополнительно. Реализация функции sscanf](#part-4-дополнительно-реализация-функции-sscanf)  
  - [Дополнительно. Реализация специальных функций обработки строк](#part-5-дополнительно-реализация-специальных-функций-обработки-строк)  

## Введение

В рамках проекта реализован набор функций для обработки строк, аналогичный функциям стандартной библиотеки string.h, с дополнительной поддержкой форматирования (sprintf, sscanf) и собственными функциями (to_upper, trim и др.).

Данная работа направлена на практическое применение структурного подхода, освоение низкоуровневой работы с памятью и реализацию поведения стандартной библиотеки без использования её готовых функций. В ходе разработки выполнено модульное тестирование с использованием библиотеки Check, проведено сравнение с функциями стандартной библиотеки и организовано формирование отчётов о покрытии кода.

Проект выполнен в составе команды. Моя зона ответственности включала написание модульных тестов, проверку корректности реализованных функций и участие в поиске и анализе ошибок.
...
### Форматирование строк (sprintf и sscanf)
...
Ниже приведены требования к реализации проекта String Plus.
...
- На реализацию функции накладываются все требования, изложенные в [первой части](#part-1-реализация-функций-библиотеки-stringh).
...
- На реализацию функций накладываются все требования, изложенные в [первой части](#part-1-реализация-функций-библиотеки-stringh), 
