...
StringPlus — это учебный проект, в рамках которого реализована собственная версия библиотеки string.h на языке C с дополнениями. Все функции разработаны с нуля в соответствии со стандартом POSIX и покрыты модульными тестами с использованием библиотеки Check.
...
Ниже приведены требования к реализации проекта StringPlus.
